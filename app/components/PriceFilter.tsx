...
import stylesheetUrl from "./PriceFilter.css";

export const links: LinksFunction = () => {
    return [{ rel: `stylesheet`, href: stylesheetUrl }];
};

// Main part taken from https://github.com/algolia/instantsearch/blob/master/examples/react-hooks/e-commerce/components/PriceSlider.tsx
